...
import { CalendarDays, CheckCircle2, Clock3, Gauge, Hand, Home, LoaderCircle, LogOut, Mic, MicOff, Music2, Octagon, Play, Radio, Sparkles, Timer, Users, Volume2, VolumeX } from "lucide-react";
...
export function MeetingSurface({ join }: { join: JoinResponse }) {
  ...
  const lobbyMusic = useLobbyMusic(isLobby && live.connection === "connected");
